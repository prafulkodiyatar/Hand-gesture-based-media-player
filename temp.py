...
while True:
    ...
    #Invert pixel value and then enchance the result for better output
    ...
    #Find Contours for specific colored object
    ...
    try:
        #print("try")
         #Find Max area contour and draw it on live feed
